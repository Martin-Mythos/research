...
| Error handling | 2 | Compare-and-set statuses/events work. The experiment safely cancels and settles timed-out attempts before retrying, but retry/timeout/drop semantics are absent from the task-store contract and were supplied by the harness. |
